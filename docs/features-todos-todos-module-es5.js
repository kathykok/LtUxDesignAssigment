(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["features-todos-todos-module"], {
    ...
    /***/
    function srcAppFeaturesTodosStoreTodosSelectorsTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _todos_state__WEBPACK = _todos_state__WEBPACK_IMPORTED_MODULE_1__["todosAdapter"].getSelectors(),
          selectAll = _todos_state__WEBPACK.selectAll;

      var selectTodosState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])('todos');
      var selectTodos = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(selectTodosState, selectAll);
      /***/
    },
    ...
    /***/
    function srcAppFeaturesTodosTodosRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _todos_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./todos.component */
    ...
    /***/
    function srcAppFeaturesTodosTodosComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _store_todos_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./store/todos.actions */
      "./src/app/features/todos/store/todos.actions.ts");
      /* harmony import */


      var _store_todos_selectors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./store/todos.selectors */
      "./src/app/features/todos/store/todos.selectors.ts");
      /* harmony import */
      ...
      function TodosComponent_div_0_mat_error_18_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function TodosComponent_div_0_mat_list_item_25_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function TodosComponent_div_0_mat_list_item_25_Template_mat_checkbox_change_1_listener($event) {
            ...
            return ctx_r7.onChange(todo_r6, $event.checked);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TodosComponent_div_0_mat_list_item_25_Template_button_click_3_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);
      ...
      function TodosComponent_div_0_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function TodosComponent_div_0_Template_form_ngSubmit_11_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function TodosComponent_div_0_Template_input_ngModelChange_16_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);

            var ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r12.newTodoName = $event;
          });
      ...
      var TodosComponent = /*#__PURE__*/function () {
        ...
        _createClass(TodosComponent, [{
          ...
          value: function onSubmit(form) {
            this.store.dispatch(Object(_store_todos_actions__WEBPACK_IMPORTED_MODULE_2__["createTodosItem"])({
              todo: {
          ...
          value: function onDelete(item) {
            this.store.dispatch(Object(_store_todos_actions__WEBPACK_IMPORTED_MODULE_2__["deleteTodosItem"])({
              todoId: item.id
            }));
          }
        }, {
          key: "onChange",
          value: function onChange(item, newDoneStatus) {
            this.store.dispatch(Object(_store_todos_actions__WEBPACK_IMPORTED_MODULE_2__["updateTodosItem"])({
              updateTodo: {
                id: item.id,
                changes: Object.assign(Object.assign({}, item), {
                  done: newDoneStatus
                })
              }
            }));
      ...
      TodosComponent.ɵfac = function TodosComponent_Factory(t) {
        return new (t || TodosComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["Store"]));
      };
      ...
      TodosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 2,
        vars: 3,
        consts: [[4, "ngIf"], ["ariaLabel", "Back to homepage", 3, "link"], [3, "addons"], ["mat-icon-button", "", "color", "primary", "aria-label", "Reload", 1, "ml-auto"], [1, "page-content"], [1, "squeeze"], [1, "mb-3"], ["novalidate", "", 3, "ngSubmit"], ["todoForm", "ngForm"], [1, "w-100"], ["matInput", "", "type", "text", "name", "todoName", "required", "", 3, "ngModel", "ngModelChange"], ["todoName", "ngModel"], [1, "text-right"], ["mat-button", "", "type", "reset"], ["mat-flat-button", "", "color", "primary", "type", "submit", 3, "disabled"], ["role", "listitem", 4, "ngFor", "ngForOf"], ["role", "listitem"], [3, "checked", "change"], ["mat-icon-button", "", "aria-label", "Delete to-do item", "color", "warn", 1, "ml-auto", 3, "click"]],
    ...
    /***/
    function srcAppFeaturesTodosTodosModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _todos_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      TodosModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        ...
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _todos_routing_module__WEBPACK_IMPORTED_MODULE_4__["TodosRoutingModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](TodosModule, {
          declarations: [_todos_component__WEBPACK_IMPORTED_MODULE_5__["TodosComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _todos_routing_module__WEBPACK_IMPORTED_MODULE_4__["TodosRoutingModule"]]
        });
      })();
      /*@__PURE__*/
...
//# sourceMappingURL=features-todos-todos-module-es5.js.map